  ...
  return {
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        ...
        'process.env.REACT_APP_PUBLIC_URL': JSON.stringify(process.env.REACT_APP_PUBLIC_URL || 'https://localhost:3000'),
        'process.env.REACT_APP_API_BASE': JSON.stringify(process.env.REACT_APP_API_BASE || 'http://localhost:3001'),
